...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texTitle.setText(R.string.login);
    ...
    public void login() {
        ...
        if (TextUtils.isEmpty(MD5.getMessageDigest(currentPassword))) {
...
//        loginAppServer();
    ...
    /*private void loginAppServer() {
        NetDao.login(this, currentUsername, MD5.getMessageDigest(currentPassword), new OkHttpUtils.OnCompleteListener<String>() {
            @Override
